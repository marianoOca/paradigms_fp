...
allTests = test [
  "ejercicio2.1" ~: testsEj21,
  "ejercicio2.2" ~: testsEj22,
  "ejercicio2.3" ~: testsEj23,
  "ejercicio2.4" ~: testsEj24,
  "ejercicio3" ~: testsEj3,
  "ejercicio4" ~: testsEj4,
  "ejercicio5" ~: testsEj5,
  "ejercicio6" ~: testsEj6,
...
testsEj3 = test [
  puroContenedor ~=? mayorCapacidad [soloUnMotor, superProtegido, puroContenedor, contenedorYCañon]
  ]

testsEj4 = test [
  puroContenedor ~=? transformar (\c -> Contenedor) escudoSinCañon
  ]
